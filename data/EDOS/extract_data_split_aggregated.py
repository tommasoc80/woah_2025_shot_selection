...
def extract_split_aggregated(inputf):
    ...
    df_train.to_csv("edos_aggregated_train.csv", columns = ['text', 'label'])
    df_dev.to_csv("edos_aggregated_dev.csv", columns = ['text', 'label'])
    df_test.to_csv("edos_aggregated_test.csv", columns = ['text', 'label'])

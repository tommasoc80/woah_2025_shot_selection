...
def train_model(tokenized_dataset, data_collator):
    ...
    training_args = TrainingArguments(
        output_dir="/scratch/p281734/sbic_ft",
        learning_rate=2e-5,
...
if __name__ == '__main__':
    ...
    dev = pd.read_csv('/scratch/p281734/SBIC_binary_aggr_dev.csv', delimiter=',', header=0)
    test = pd.read_csv('/scratch/p281734/SBIC_binary_aggr_test.csv', delimiter=',', header=0)

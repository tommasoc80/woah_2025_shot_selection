...
{'text': 'Because in the 1940's & 50's it was still OK to beat your wife.', 'label': 0},
...
{'text': 'Can't wait to see if the Ms Marvel doll has her clit chopped off in true Muslim fashion.', 'label': 1},
...
if __name__ == "__main__":
    ...
    df.to_csv('/scratch-shared/tcaselli/edos_llama3_70_difficult_not_first.csv', index=False)
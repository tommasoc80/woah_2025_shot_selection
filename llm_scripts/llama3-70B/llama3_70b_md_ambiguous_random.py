...
{'text': 'This seems like a pretty thin platform. I predict it will break under the weight of Trump. I wonder How long can they pretend the Pandemic isn't relevant?', 'label': 1},        
...
{'text': 'When it’s fashionable eh? Fuck off. <url>', 'label': 1},        
...
if __name__ == "__main__":
    ...
    df.to_csv('/scratch-shared/tcaselli/md_llama3_70_ambiguous_random.csv', index=False)
...
{'text': '"THE MAJORITY WILL NEVER allow the Mentally Ill Globalists to turn the world into a SJW and Radical Islam ""SAFE SPACE"" #brexit #Trump2016"', 'label': 0},       
...
if __name__ == "__main__":
    ...
    df.to_csv('/scratch-shared/tcaselli/brexit_llama3_70_difficult_random.csv', index=False)